...
local graphic_text_editor = "gvim"
...
local global_keys = awful.util.table.join(
  ...
  awful.key({ "Mod1" }, "Tab", function() change_focused_client(1) end, { description="Change focused client to next", group="Client" }),
  ...
  awful.key({ "Mod4" }, "h",  function() awful.tag.viewidx(-1) end),
  awful.key({ "Mod4" }, "Right", function() awful.tag.viewidx(1) end),
  awful.key({ "Mod4" }, "l", function() awful.tag.viewidx(1) end),
  ...
  awful.key({ "Mod1", "Control" }, "l", function() awful.spawn(session_lock_command) end, { description="Lock the session", group="Session" }),
...
local client_keys = awful.util.table.join(
  ...
  awful.key({ "Mod1" }, "F4", function(c) c:kill() end, { description="Kill focused client", group="Client" }),
  ...
  awful.key({ "Mod4", "Control" }, "m", maximize_client_to_multiple_monitor, { description="Maximize client to multiple monitors", group="Client" }),
